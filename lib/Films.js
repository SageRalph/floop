...
function editFilm(users, row, film) {
    ...
    if (alwaysEditingFilms) {
        ...
        if (isSet(film.trailer)) {
            ...
            trailerCell.appendChild(newIconBtn("./Res/searchIcon.png", function () {
        ...
        var autoTrailerBtn = newIconBtn("./Res/searchIcon.png", function () {
...
function appendFilmButtons(row, film, users, editing) {
    ...
    // Watched button
    var watchedBtn = newIconBtn("./Res/watchIcon.png", markWatched.bind(null,
    ...
    if (!alwaysEditingFilms || film.title === "") {
        if (editing) {
            appendBtnCell(row, newIconBtn("./Res/checkIcon.png", manageFilms));
        } else {
            appendBtnCell(row, newIconBtn("./Res/editIcon.png", editFilm.bind(null, users, row, film)));
        }
    }

    // Remove button
    if (film.title !== "") {
        appendBtnCell(row, newIconBtn('./Res/removeIcon.png', removeFilm.bind(null, row, film.filmID)));
    }
}
